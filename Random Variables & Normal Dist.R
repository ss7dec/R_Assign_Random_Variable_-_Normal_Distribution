...
# B  i.e. 0.2676 .
# In brief, 26.7% probability is there that the service manager cannot meet his 
# commitment.
...
round(pnorm(q=30, mean=38, sd= 6, lower.tail = FALSE),3)

# In brief, 90.9% of the employees ages could lie under the age of 30. Hence, the centre
...
#
#Hence the answer is D: 48.5, 151.5  
